...
- **Stack:** Kotlin Multiplatform 2.1.21 (wasmWasi + jvm targets), Gradle 9.4, Node.js 22+ (WASI host — WasmGC requires 22+), Java 21+ (build only)
...
- Node.js **22+** required as WASI host; Node.js 20 lacks native WasmGC support (type 0x4e) — Kotlin/Wasm output requires WasmGC
